#!/usr/bin/env python3
"""
Final Hyperparameter Optimization for AML Detection
===================================================

This script uses a completely fixed architecture with proper dimension handling
to avoid all tensor dimension issues.
"""
...
print("🔧 Final Hyperparameter Optimization for AML Detection")
print("=" * 60)

class FinalEdgeLevelGNN(nn.Module):
    """Final GNN for edge-level classification with completely fixed architecture"""
    def __init__(self, input_dim, hidden_dim, output_dim, dropout=0.1):
        super(FinalEdgeLevelGNN, self).__init__()
        ...
        # COMPLETELY FIXED edge classifier - no assumptions about dimensions
        # We'll create it dynamically based on actual input size
    ...
    def forward(self, x, edge_index, edge_attr=None):
        ...
        # Edge-level classification with DYNAMIC dimension handling
        ...
        # Create edge classifier dynamically based on ACTUAL input size
        ...
        # Use the dynamically created classifier
...
def load_optimization_dataset():
    ...
    print("📊 Loading dataset for final optimization...")
...
def final_hyperparameter_optimization():
    """Perform final hyperparameter optimization with proper dimension handling"""
    print("🔧 Starting Final Hyperparameter Optimization...")
    ...
    n_trials = 20  # Reduced number of trials for testing
    results = []
    best_score = 0.0
    best_config = None
    
    print(f"🔧 Testing {n_trials} final hyperparameter combinations...")
    
    for i in tqdm(range(n_trials), desc="Final Optimization"):
...
def main():
    ...
    best_config, best_score, results = final_hyperparameter_optimization()
    ...
    with open('/content/drive/MyDrive/LaunDetection/final_hyperparameter_results.pkl', 'wb') as f:
        pickle.dump(results_data, f)
    
    print(f"✅ Results saved to final_hyperparameter_results.pkl")
